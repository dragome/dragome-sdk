...
public class ParameterizedTypeImpl implements ParameterizedType
{
	...
	public ParameterizedTypeImpl(String genericSignature)
	{
		...
		try
		{
			...
			createTypeArgumentsFromSignature(actualTypeArgumentsString);
	...
	private void createTypeArgumentsFromSignature(String actualTypeArgumentsString) throws ClassNotFoundException
	{
		String[] typesParts= actualTypeArgumentsString.split(";");
		List<Type> typeParameters= new ArrayList<Type>();
		for (String typeArgumentsString : typesParts)
		{
			if (typeArgumentsString.contains("<"))
				typeParameters.add(new ParameterizedTypeImpl(typeArgumentsString));
			else
				typeParameters.add(Class.forName(removeSpecialChars(typeArgumentsString)));
		}

		actualTypeArguments= typeParameters.toArray(new Type[0]);
	}
