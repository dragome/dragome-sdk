 ...
 * calling {@link BigAny#round round} on this number with the
 ...
 * enumeration of rounding mode constants in {@link BigAny}
 * ({@link BigAny#ROUND_UP}, {@link BigAny#ROUND_DOWN},
 * etc. ).
 *
 * @see     BigAny
 * @see     MathContext
...
public enum RoundingMode {
    ...
    HALF_UP(BigAny.ROUND_HALF_UP),
         ...
         *</table>
         */
    HALF_DOWN(BigAny.ROUND_HALF_DOWN),
         ...
         *</table>
         */
    HALF_EVEN(BigAny.ROUND_HALF_EVEN),
         ...
         *</table>
         */
    UNNECESSARY(BigAny.ROUND_UNNECESSARY);
     ...
     * legacy integer rounding mode constant in {@link BigAny}.
     *
    ...
    public static RoundingMode valueOf(int rm) {
        ...
        case BigAny.ROUND_UP:
            return UP;

        case BigAny.ROUND_DOWN:
            return DOWN;

        case BigAny.ROUND_CEILING:
            return CEILING;

        case BigAny.ROUND_FLOOR:
            return FLOOR;

        case BigAny.ROUND_HALF_UP:
            return HALF_UP;

        case BigAny.ROUND_HALF_DOWN:
            return HALF_DOWN;

        case BigAny.ROUND_HALF_EVEN:
            return HALF_EVEN;

        case BigAny.ROUND_UNNECESSARY:
            return UNNECESSARY;
