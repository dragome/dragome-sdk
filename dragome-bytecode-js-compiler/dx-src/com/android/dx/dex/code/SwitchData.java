...
public final class SwitchData extends VariableSizeInsn {
     ...
     * 
     * @return {@code true} if the data is to be packed
     */
    ...
    /**
     * Returns the sorted list of switch cases (keys) .
     */
    ...
    /**
     * Returns  the corresponding list of code addresses; the branch
     * target for each case
     */
    public CodeAddress[] getTargets() {
    	return targets;
    }
