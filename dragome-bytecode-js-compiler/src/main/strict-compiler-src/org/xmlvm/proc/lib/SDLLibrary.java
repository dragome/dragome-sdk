...
public class SDLLibrary extends Library
{
	private static final String ONE_JAR_LOCATION= "/lib/sdl-java.jar";
	private static final String FILE_SYSTEM_LOCATION= "bin-sdl";
