...
{
	private static final Type<ValidationHandler> TYPE= new Type<ValidationHandler>();
	...
	public static void fire(HasValidationHandlers source, ValidationResult validationResult)
	{
		source.fireEvent(new ValidationEvent(validationResult));
	}
	...
	public void dispatch(ValidationHandler handler)
	{
