# Dragome status: current version 0.95.1-beta1
 ...
 6. Generated js contains all compiled code, too big generated files. Need to be split in several files to be able to cache each one. Also closure js optimizer cannot shrink the file by now, generated code should be changed to allow it. 
