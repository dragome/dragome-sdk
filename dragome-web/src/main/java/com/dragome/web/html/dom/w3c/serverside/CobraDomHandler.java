 ...
 */
package com.dragome.web.html.dom.w3c.serverside;
...
public class CobraDomHandler implements DomHandler
{
	...
	public Document createRemoteDocumentInstance()
	{
		try
		{
			...
			String documentHtml= (String) ScriptHelper.eval("document.documentElement.innerHTML", null);
			htmlParser.parse(new StringReader(documentHtml));

			Object documentNode= ScriptHelper.eval("document", null);
			return new BrowserDomHandler().castTo(documentNode, Document.class, null);
			//			
